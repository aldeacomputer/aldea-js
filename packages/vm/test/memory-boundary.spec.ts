...
describe('reading basic types from memory', () => {
  it('reads i8 as number', async () => {
    ...
    const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [])
...
describe('writing basic types to memory', () => {
  it('writes number as i8', async () => {
    ...
    const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [-42])
  ...
  it('writes bigint as i64', async () => {
    const wasm = await compileToWasm('export function test(a: i64): bool { return a == -42 }')
    const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [-42n])
    assert.isTrue(res.value)
  })
  ...
  it('writes number as f32', async () => {
    ...
    const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [42.12345])
    assert.isTrue(res.value)
  })
...
describe('writing complex types to memory', () => {
  describe('typed arrays', () => {
    it('writes Int8Array', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new Int8Array([11, 22, 33])])
      assert.isTrue(res.value)
    })
    ...
    it('writes Int16Array', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new Int16Array([11, 22, 33])])
      assert.isTrue(res.value)
    })
    ...
    it('writes Int32Array', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new Int32Array([11, 22, 33])])
      assert.isTrue(res.value)
    })
    ...
    it('writes Int64Array', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new BigInt64Array([11n, 22n, 33n])])
      assert.isTrue(res.value)
    })
    ...
    it('writes Uint8Array', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new Uint8Array([11, 22, 33])])
      assert.isTrue(res.value)
    })
    ...
    it('writes Uint16Array', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new Uint16Array([11, 22, 33])])
      assert.isTrue(res.value)
    })
    ...
    it('writes Uint32Array', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new Uint32Array([11, 22, 33])])
      assert.isTrue(res.value)
    })
    ...
    it('writes Uint64Array', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new BigUint64Array([11n, 22n, 33n])])
      assert.isTrue(res.value)
    })
    ...
    it('writes Float32Array', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new Float32Array([11.1, 22.2, 33.3])])
      assert.isTrue(res.value)
    })
    ...
    it('writes Float64Array', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new Float64Array([11.1, 22.2, 33.3])])
      assert.isTrue(res.value)
    })
  })
  ...
  describe('arrays and static arrays', () => {
    it('writes array with u8 values', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [[11, 22, 33]])
      assert.isTrue(res.value)
    })
    ...
    it('writes array with string values', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [['aaa', 'bbb', 'ccc']])
      assert.isTrue(res.value)
    })
  ...
  describe('maps with combos of types', () => {
    it('writes map with u8 keys and u8 values', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new Map([[1, 11], [2, 22], [3, 33]])])
      assert.isTrue(res.value)
    })
  ...
  describe('sets with different types', () => {
    it('writes set with u8 entries', async () => {
      ...
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [new Set([11, 22, 33])])
      assert.isTrue(res.value)
    })
  ...
  describe('objects', () => {
    it('writes plain objects', async() => {
      ...
      const wasm = await compileToWasm(code)
      const res = wasm.functionCall(wasm.abi.exportedFnByName('test'), [{ name: 'Fred', age: 42 }])
      assert.isTrue(res.value)
    })
  })
})
