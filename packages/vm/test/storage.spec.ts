...
//       const pkg = exec.importModule(modIdFor('flock')).asContainer
...
//       const exec = emptyExec()
//       const pkgIndex = exec.importModule(modIdFor('flock')).asContainer
...
//
//       const exec2 = emptyExec([userPriv])
//       const pkgIndex2 = exec2.importModule(modIdFor('flock')).asContainer
