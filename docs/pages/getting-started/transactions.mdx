...
The juicy part of this script is lines 6 to 10 - this is where the transaction-building magic happens. An Aldea transaction is simply a list of instructions so lets follow the code and see if we can work out what is happening...
