...
In the last step your deployed your first package. Now comes the fun part -  It's time to create and interact with some Jigs!
...
The juicy part of this script is lines 6 to 10 - this is where the tranaction-building magic happens. An Aldea transaction is simply a list of instructions so lets the follow the code and see if we can work out what is happening...
...
<CodeContainer lang="text" lines={false}>
    ```
    Created item:
    ID       9dfb57316a29491a197444176a7248453b70b5e91e8c1e1addac134d58c51489
    Location 978bc5870544cc18524604adb1d80ec91c3a3160109cf5cb7418145420895af6_0
    Origin   978bc5870544cc18524604adb1d80ec91c3a3160109cf5cb7418145420895af6_0
...
Hopefully this guide has allowed you to appreciate the simplicity and familiarity of the Jig programming model. But don't be fooled, that simplicity belies the power of Jigs. From tokens and game items through to smart contracts and metaverse virtual worlds, Jigs offer an exciting vision of a future on-chain world. A world that is waiting for you to build.
