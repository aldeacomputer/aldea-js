...
Document that describes how to interact with a package on the  Aldea Computer.
...
A Pointer derived from the txid and output index from the transaction in which the Jig was initialised. Is a permanent reference to a Jig instance.
