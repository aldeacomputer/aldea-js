...
A Jig is a programmable digital object. Like any object, Jigs contain state and behavior, and can be interacted with through methods. But Jig's exist on a blockchain and have some special characteristics because of this.
