...
A Jig is a programmable digital object. Like any object, Jigs contain state and behaviour, and can be interracted with through methods. But Jig's exist on a blockchain and have some special characteristics because of this.

![jigs illustration](/jigs.png)
